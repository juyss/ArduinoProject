...
#define OLED_MOSI   13    //D6 gpio12
#define OLED_CLK   14     //D7 gpio13
#define OLED_DC    4     //D5 gpio14
#define OLED_CS    15     //D8 gpio15
#define OLED_RESET 16     //D0 gpio16
...
//    int nian = riqi.lastIndexOf("T");
    hTime.Year = (riqi.substring(0, 5)).toInt();
